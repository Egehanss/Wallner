	...
	private function registerSpawnEggs() : void{
		...
		$this->register(new class(new IID(Ids::SPAWN_EGG, EntityLegacyIds::VILLAGER), "Villager Spawn Egg") extends SpawnEgg{
			...
			public function createEntity(World $world, Vector3 $pos, float $yaw, float $pitch) : Entity{
			    ...
			    $this->register(new class(new IID(Ids::SPAWN_EGG, EntityLegacyIds::ZOMBIE_VILLAGER), "Zombie Villager Spawn Egg") extends SpawnEgg{
			public function createEntity(World $world, Vector3 $pos, float $yaw, float $pitch) : Entity{
			...
			public function createEntity(World $world, Vector3 $pos, float $yaw, float $pitch) : Entity{
			    ...
			    $this->register(new class(new IID(Ids::SPAWN_EGG, EntityLegacyIds::TROPICALFISH), "TropicalFish Spawn Egg") extends SpawnEgg{
			public function createEntity(World $world, Vector3 $pos, float $yaw, float $pitch) : Entity{
			...
			public function createEntity(World $world, Vector3 $pos, float $yaw, float $pitch) : Entity{
			    ...
			    $this->register(new class(new IID(Ids::SPAWN_EGG, EntityLegacyIds::LLAMA_SPIT), "Llama Spawn Egg") extends SpawnEgg{
			public function createEntity(World $world, Vector3 $pos, float $yaw, float $pitch) : Entity{
				return new Llama(Location::fromObject($pos, $world, $yaw, $pitch));
			}
		});
			    $this->register(new class(new IID(Ids::SPAWN_EGG, EntityLegacyIds::IRON_GOLEM), "IronGolem Spawn Egg") extends SpawnEgg{
			public function createEntity(World $world, Vector3 $pos, float $yaw, float $pitch) : Entity{
