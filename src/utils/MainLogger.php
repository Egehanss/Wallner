...
class MainLogger extends \AttachableThreadedLogger implements \BufferedLogger{
	...
	private string $format = TextFormat::GREEN . "[%s] " . TextFormat::RESET . "%s[%s/%s]: %s" . TextFormat::RESET;
	...
	public function emergency($message){
		$this->send($message, \LogLevel::EMERGENCY, "ACIL-DURUM", TextFormat::RED);
	}

	public function alert($message){
		$this->send($message, \LogLevel::ALERT, "ALARM", TextFormat::RED);
	}
	...
	public function error($message){
		$this->send($message, \LogLevel::ERROR, "HATA", TextFormat::DARK_RED);
	}

	public function warning($message){
		$this->send($message, \LogLevel::WARNING, "UYARI", TextFormat::YELLOW);
	}

	public function notice($message){
		$this->send($message, \LogLevel::NOTICE, "DIKKAT", TextFormat::AQUA);
	}

	public function info($message){
		$this->send($message, \LogLevel::INFO, "BILGILENDIRME", TextFormat::WHITE);
	}
	...
	public function debug($message, bool $force = false){
		...
		$this->send($message, \LogLevel::DEBUG, "HATA-AYIKLAMA", TextFormat::GRAY);
	}
