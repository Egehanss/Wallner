...
use pocketmine\wallner\block\tile\Campfire as TileCampfire;
use pocketmine\wallner\block\Lodestone as TileLodestone;
...
class BlockManager
{
    ...
    public static function init(): void
    {
       ...
       # $bf->register(new BeeNest(new BID(473, 0, -218), "Bee Nest", new BlockBreakInfo(0.3, BlockToolType::AXE, 0.3)), true);
        $bf->register(new BeeNest(new BID(473, 0, 9870), "Bee Nest", new BlockBreakInfo(0.3, BlockToolType::AXE, 0.3)), true);
