...
use pocketmine\block\tile\BlockEntityHopper as BTileHopper;
...
class BlockFactory{
	...
	public function __construct(){
        ...
        $deepslateOreBreakInfo = new BreakInfo(4.5, ToolType::PICKAXE, ToolTier::STONE()->getHarvestLevel(), 30.0);

       $this->registerAllMeta(new Opaque(new BID(Ids::DEEPSLATE_COAL_ORE, 0), "Deepslate Coal Ore", new BreakInfo(4.5, ToolType::PICKAXE, ToolTier::WOOD()->getHarvestLevel())));
       $this->registerAllMeta(new Opaque(new BID(Ids::DEEPSLATE_COPPER_ORE, 0), "Deepslate Copper Ore", new BreakInfo(4.5, ToolType::PICKAXE, ToolTier::STONE()->getHarvestLevel())));
       $this->registerAllMeta(new Opaque(new BID(Ids::DEEPSLATE_DIAMOND_ORE, 0), "Deepslate Diamond Ore", new BreakInfo(4.5, ToolType::PICKAXE, ToolTier::IRON()->getHarvestLevel())));
		...
		#$this->registerAllMeta(new BlockHopper(new BID(Ids::HOPPER_BLOCK, 0, ItemIds::HOPPER, BlockEntityHopper::class), "Hopper", new BreakInfo(3.0, ToolType::PICKAXE, ToolTier::WOOD()->getHarvestLevel(), 15.0)));
