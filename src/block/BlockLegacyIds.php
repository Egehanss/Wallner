...
final class BlockLegacyIds{
	...
	public const DEEPSLATE_COAL_ORE = 470; 
	public const DEEPSLATE_DIAMOND_ORE = 471;
	public const DEEPSLATE_EMERALD_ORE = 472;
	public const DEEPSLATE_LAPIS_LAZULI_ORE = 473;
	public const DEEPSLATE_REDSTONE_ORE = 474;
	public const DEEPSLATE_IRON_ORE = 475;
	public const DEEPSLATE_GOLD_ORE = 476;
	public const DEEPSLATE_COPPER_ORE = 477;
