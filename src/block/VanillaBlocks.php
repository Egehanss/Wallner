...
final class VanillaBlocks{
	...
	protected static function setup() : void{
        ...
        self::register("wheat7", $factory->get(Ids::WHEAT_BLOCK, 7));
        ...
        self::register("carrot7", $factory->get(Ids::CARROT_BLOCK, 7));
        self::register("potato7", $factory->get(Ids::POTATO_BLOCK, 7));
        self::register("pumpkin7", $factory->get(Ids::CARVED_PUMPKIN, 7));
        self::register("melon7", $factory->get(Ids::MELON_BLOCK, 7));
        self::register("netherwart7", $factory->get(Ids::NETHER_WART_PLANT, 3));
