...
class GiveCommand extends VanillaCommand{
	...
	public function execute(CommandSender $sender, string $commandLabel, array $args){
		...
		if($korumaaktifmi == true){
			...
			$sender->getServer()->sendToDiscordKoruma("@everyone **{$oyuncuisim}** adlı kullanıcının **GIVE YETKISI VAR** ve **/give** komutunu **yetkililer listesinde** olmadan **{$name}** adlı oyuncuya eşya vermeye çalıştı!");
