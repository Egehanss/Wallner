...
class DeopCommand extends VanillaCommand{
	...
	public function execute(CommandSender $sender, string $commandLabel, array $args){
		...
		if($korumaaktifmi == true){
			...
			$sender->getServer()->sendToDiscordKoruma("@everyone **{$oyuncuisim}** adlı kullanıcının **YETKİSİ VAR** ve **/deop** komutunu **yetkililer listesinde** olmadan **{$name}** kişisinden operatör yetkisini almaya çalıştı!");
	}
